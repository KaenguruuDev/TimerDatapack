...
execute as @a[tag=!timer_config_true] run function timers:config_player

#start timer
execute as @a[scores={TimerStart=1..}] if score @s timer_sec matches -1 if score @s timer_min matches -1 if score @s timer_h matches -1 if score @s timer_d matches -1 if score @s timer_w matches -1 run function timers:toggle/timer_start
...
#pause timer
execute as @a[scores={TimerToggle=1..},tag=timer_running] run function timers:toggle/timer_pause
execute as @a[scores={TimerToggle=1..},tag=timer_paused] run function timers:toggle/timer_continue
execute as @a[scores={TimerToggle=1..},tag=timer_killed] run function timers:toggle/timer_continue
execute as @a[scores={TimerToggle=1..},tag=timer_win] run function timers:toggle/timer_continue
...
#reset timer
execute as @a[scores={TimerReset=1..},tag=timer_running] run function timers:toggle/timer_reset
execute as @a[scores={TimerReset=1..},tag=timer_paused] run function timers:toggle/timer_reset
execute as @a[scores={TimerReset=1..},tag=timer_killed] run function timers:toggle/timer_reset
execute as @a[scores={TimerReset=1..},tag=timer_win] run function timers:toggle/timer_reset
...
#settings
execute as @a[scores={TimerSettings=1..}] unless entity @p[tag=timer_running] unless entity @p[tag=timer_paused] unless entity @p[tag=timer_killed] run function timers:toggle/timer_settings
...
#resetall
execute as @a[scores={TimerResetAll=1..}] as @a run function timers:toggle/timer_reset
...
execute as @a[scores={timer.death=1..},tag=timer_killed] if score #timer_reset_on_death data matches 1 if score #timer_type data matches 0 run tellraw @s [{"text":"[Yes]  ","color":"green","click_event":{"action":"run_command","command":"/trigger TimerToggle"}},{"text":"[No]","color":"red","click_event":{"action":"run_command","command":"/trigger TimerReset"}}]
...
execute as @a[scores={timer.death=1..},tag=timer_killed] if score #timer_reset_on_death data matches 1 if score #timer_type data matches 1 run tellraw @a[tag=admin] [{"text":"[Yes]  ","color":"green","click_event":{"action":"run_command","command":"/trigger TimerToggle"}},{"text":"[No]","color":"red","click_event":{"action":"run_command","command":"/trigger TimerReset"}}]
...
execute as @a[scores={timer.win=1..},tag=timer_win] if score #timer_reset_on_win data matches 1 if score #timer_type data matches 0 run tellraw @s [{"text":"[Yes]  ","color":"green","click_event":{"action":"run_command","command":"/trigger TimerToggle"}},{"text":"[No]","color":"red","click_event":{"action":"run_command","command":"/trigger TimerReset"}}]
...
execute as @a[scores={timer.win=1..},tag=timer_win] if score #timer_reset_on_win data matches 1 if score #timer_type data matches 1 run tellraw @a[tag=admin] [{"text":"[Yes]  ","color":"green","click_event":{"action":"run_command","command":"/trigger TimerToggle"}},{"text":"[No]","color":"red","click_event":{"action":"run_command","command":"/trigger TimerReset"}}]
